...
select * from schedule where start_date = to_date('05/19/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('05/26/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('06/02/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('06/09/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('06/16/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('06/23/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('06/30/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('07/07/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('07/14/2013','MM/DD/YYYY') and comp_str_id = 5673
select * from schedule where start_date = to_date('07/21/2013','MM/DD/YYYY') and comp_str_id = 5673
*/