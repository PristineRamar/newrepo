define the_store_id = 5651;
--define ad_calendar_id = 3693; 
define curr_schedule_id = 6366; 
define ddod_id = 6;
...
prev_day_exp, mape, s.tod_id,sigma_used,sixty_four_exp,focus_item
...
/*
select * from schedule where start_date = to_date('03/17/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('03/24/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('03/31/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('04/07/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('04/14/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('04/21/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('04/28/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('05/05/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('05/12/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('05/19/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('05/26/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('06/02/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('06/09/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('06/16/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('06/23/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('06/30/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('07/07/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('07/14/2013','MM/DD/YYYY') and comp_str_id = 5651
select * from schedule where start_date = to_date('07/21/2013','MM/DD/YYYY') and comp_str_id = 5651
*/
