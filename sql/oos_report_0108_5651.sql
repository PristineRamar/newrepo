...
--define curr_date = to_date('04/04/2013','MM/DD/YYYY');

define curr_schedule_id = 5880; 
define ddod_id = 4;

define prev_schedule_id =  5879;
define sprev_schedule_id =  5880;  
...
TableA.quantity,round(exp_quantity), 
round(TableA.last_7day_exp), TableA.last_7day_obs,round(TableA.last_28day_exp), TableA.last_28day_obs,
TableA.unit_price, TableA.unit_reg_price,TableA.purchase_count, exp_purchase_count, TableA.total_visit_count, exp_total_visit_count, TableA.oos_ind
,
/*
case when 
...
*/
(case when sprev.promotional_ind = 'Y' then sprev.quantity_sale else sprev.quantity_reg end) prev_day_quantity,
days_moved_last_week,round(q1a) avgQ,
...
, presto_item_code, round(exp_quantityOld), ship.shipment_date, ship.quantity
...
s.oos_ind oos_ind, oosl.name ooscl, s.oos_score, last_7day_exp,last_7day_obs,last_28day_exp,last_28day_obs,
