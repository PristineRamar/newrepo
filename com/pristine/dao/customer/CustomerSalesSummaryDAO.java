...
public class CustomerSalesSummaryDAO {
	...
	public boolean deleteCustomerSegmentData(Connection conn,int storeId, 
							int calid) throws GeneralException,SQLException {
		
		StringBuffer sbb = new StringBuffer("delete from CUSTOMER_SEGMENT_DATA");	    
		sbb.append(" where STORE_ID = ").append(storeId);
		sbb.append(" AND CALENDAR_ID = ").append(calid);	    

		logger.debug("Delete Customer Segment SQL:" + sbb);
		PristineDBUtil.execute(conn, sbb, "CustomerSegmentationDAO - delete");		
