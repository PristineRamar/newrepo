...
public class AdDataService {
	 ...
	 */
	public HashMap<Integer, List<PRItemAdInfoDTO>> getAdDetails(Connection conn, List<Integer> storeList,
		...
		if (recommendationInputDTO.isPriceTestZone())
			...
			adDetails = new PricingEngineDAO().getAdDetails(conn, recommendationInputDTO.getProductLevelId(),
