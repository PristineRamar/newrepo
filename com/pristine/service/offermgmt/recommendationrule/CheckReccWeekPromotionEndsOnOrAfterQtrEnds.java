...
public class CheckReccWeekPromotionEndsOnOrAfterQtrEnds extends RetainCurrentRetailRule {

	@SuppressWarnings("unused")
	private PRItemDTO itemDTO;
	HashMap<String, List<RecommendationRuleMapDTO>> recommendationRuleMap;
	private final String ruleCode = "R22";
	public CheckReccWeekPromotionEndsOnOrAfterQtrEnds(PRItemDTO itemDTO,
			HashMap<String, List<RecommendationRuleMapDTO>> recommendationRuleMap) {
