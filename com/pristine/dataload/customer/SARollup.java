/*
 * Title: Household summary weekly and Period
 *
 *******************************************************************************
 ...
 *------------------------------------------------------------------------------
 * Version 0.1	21/03/2017	John Britto		Initial Version 
 **********************************************************************************
 */
...
public class SARollup {

	static Logger logger = Logger.getLogger("HouseholdSalesSummaryWP");
	...
	private String _tableNameSummary = null;     // hold the name of table
	private String _tableNameItem = null;     // hold the name of table
	 ...
	 * ****************************************************************
	 */
	public SARollup(Date processDate, String storeNo, String districtNo, 
		...
		if(mode.equalsIgnoreCase(Constants.CALENDAR_PERIOD)){
			_tableNameSummary = "CST_HH_SALES_SUMMARY_PERIOD";
			_tableNameItem = "CST_HH_SALES_ITEM_SUMMARY_PERIOD";
		}
		else{
			_tableNameSummary = "CST_HH_SALES_SUMMARY_WEEKLY";
			_tableNameItem = "CST_HH_SALES_ITEM_SUMMARY_WEEKLY";
			_calMode = "W";
		}
	...
	public static void main(String[] args) throws GeneralException {
		...
		try {
			...
			summaryWeekly = new SARollup(processDate, storeNo, districtNo, mode, updatePLOnly);
		...
		try{
			if (!_updateOnlyPLMetrics){
				...
				objSA.deletePreviousAggregation(_conn, dailyCalendarDto, 
									_tableNameSummary, objStoreDto.getstoreNumber(), "0");
			}
			
			//Process data
			objSA.processSalesAggregation(_conn, dailyCalendarDto, _tableNameSummary, 
