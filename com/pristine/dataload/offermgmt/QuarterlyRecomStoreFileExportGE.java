...
public class QuarterlyRecomStoreFileExportGE {
	...
	public QuarterlyRecomStoreFileExportGE(){
  ...
  public static void main(String[] args) throws GeneralException {
	QuarterlyRecomStoreFileExportGE storeFileExport = new QuarterlyRecomStoreFileExportGE();
  ...
  private void processStoreExportData(){
	 ...
	 try
		{
		 ...
		 List<PRRecommendationRunHeader> recHeaderList = 
	 		storeFileExportDAO.getApprovedQuarterlyRecHeader(conn);
		 ...
		 if (recHeaderList != null && recHeaderList.size() > 0){
			 ...
			 for (int i=0; i < recHeaderList.size(); i++){
				 ...
				 storeFileExportDAO.getQuarterlyRecDataForStoreExport(
	...
	private void UpdateStatus(List<PRRecommendationRunHeader> recHeaderList) throws GeneralException{
		...
		try{
			...
			List<Long> runIdList = recHeaderList.stream().map(PRRecommendationRunHeader::getRunId).collect(Collectors.toList());
	...
	private void addNotification(Connection conn, List<Long> runIdList)
